(function (bunch) {
	...
	bunch.define('callableValue', function () {
		return (a) => console.log('value: ', a);
	});

	bunch.resolve(function (callableValue) {
		console.log('callableValue: ', callableValue);
		console.log('type: ', typeof callableValue);

		callableValue('lksjdflksjdf');
	});
